                    ...
                    {isLoading ? (
                        ...
                        compras.map((compra) => (
                            <tr key={compra.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{compra.contacto ?? '-'}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{compra.telefono ?? '-'}</td>
